...
4. Discord-specific handling: Craig tracks are silence-gated by Discord's own transmission, so silence is *true* silence, not room tone. Do not apply aggressive noise-floor adaptation that would swallow quiet speech after a long gap.
