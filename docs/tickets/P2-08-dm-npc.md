...
5. **New NPC discovery**: a recurring unlabelled DM voice cluster with a consistent nearby name proposes a new NPC registry entry — as a *proposal* in the QA report, never an automatic write to `campaign/npcs.json`.
