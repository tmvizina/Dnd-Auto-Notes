...
**Overall:** 30 done, 3 in progress, 1 blocked, 18 todo - 52 total (57.7% done)
...
| Ticket                                        | Status      | Assignee   | Commit | Title                             |
| --------------------------------------------- | ----------- | ---------- | ------ | --------------------------------- |
| [P3-01](tickets/P3-01-event-model.md)         | in_progress | luna-p3-01 | -      | Event model and timeline assembly |
