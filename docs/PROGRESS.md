...
**Overall:** 14 done, 2 in progress, 1 blocked, 35 todo - 52 total (26.9% done)
...
| [P1-06](tickets/P1-06-roll20-timestamps.md)     | in_progress | luna-p1-06   | —         | Roll20 timestamp recovery                |
...
| [P1-09](tickets/P1-09-intake-stage-cli.md)      | todo        | —            | —         | Intake stage and the pipeline CLI        |
| [P1-10](tickets/P1-10-intake-qa.md)             | todo        | —            | —         | Intake QA report                         |

## Phase 2 — Transcript and persona

| Ticket                                         | Status | Assignee | Commit | Title                                           |
| ---------------------------------------------- | ------ | -------- | ------ | ----------------------------------------------- |
| [P2-01](tickets/P2-01-vad.md)                  | todo   | —        | —      | VAD segmentation                                |
...
| [P4-03](tickets/P4-03-renderer-shell.md)      | todo        | —            | —         | Renderer transport and app shell          |
| [P4-04](tickets/P4-04-sidecar-supervision.md) | in_progress | luna-p4-04   | -         | Sidecar supervision from the main process |
| [P4-05](tickets/P4-05-sessions-intake-ui.md)  | todo        | —            | —         | Sessions list and intake UI               |
