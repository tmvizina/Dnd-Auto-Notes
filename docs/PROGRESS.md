...
**Overall:** 23 done, 3 in progress, 1 blocked, 25 todo - 52 total (44.2% done)
...
| [P2-04](tickets/P2-04-utterance-features.md)   | in_progress | luna-p2-04 | -         | Utterance embeddings and prosody features       |
...
| [P4-06](tickets/P4-06-run-streaming.md)       | in_progress | luna-p4-06   | -         | Pipeline run streaming                    |
